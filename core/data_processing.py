# ===========================================
# Archivo: core/data_processing.py (v2.2)
# CORRECCIÓN: Ahora retorna los promedios de liga para su uso posterior
# ===========================================
import pandas as pd
import numpy as np
import json
...
def extract_quarter_data_for_alerts(match: Dict[str, Any], home_team: str, away_team: str) -> Dict[str, Any]:
    """Extrae datos por cuarto de la nueva estructura."""
...
def process_raw_matches(league_data_raw: List[Dict]) -> Tuple[List[Dict], Dict[str, float]]:
    """
    🔄 FUNCIÓN PRINCIPAL ACTUALIZADA: Procesa nueva estructura JSON y retorna promedios.
    """
    processed_matches = []
